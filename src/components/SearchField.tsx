...
const SearchField = ({ onHandlerChange, onHandleSubmit, handleToggleModal, searchUser }: Props) => {
  return (
    <div className='bg-bgColor py-1 pr-1 pl-5 rounded-md border border-gitGray space-x-1 flex w-full justify-between flex-row focus-within:border-gitBlue'>
      <form className='w-full item-center justify-between flex' onSubmit={onHandleSubmit}>
